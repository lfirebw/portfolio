...
export default function TechnologiesSection()
{
    ...
    return (
        <section id='skill' className="py-20 bg-gradient-to-b from-vscode-blue via-blue-900 to-deep-space-black">
            <div className='container mx-auto'>
                <h1 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-100 to-gunmetal-gray my-4">
                    { t("tech") }
                </h1>
                ...
                <div className="flex flex-wrap">
                    <div className="w-1/2 flex-auto">
                        ...
                        <div className="TechnologiesStyles__ListContainer-sc-1ehw0pq-3 dPpGTk">
                            ...
                            <ul className="flex gap-3">
                                <li>
                                    <i className="colored devicon-javascript-plain text-5xl"></i>
                                </li>
                                <li>
                                    <i className="devicon-react-plain colored text-5xl"></i>
                                </li>
                                <li>
                                    <i className="devicon-angular-plain colored text-5xl"></i>
                                </li>
                                <li>
                    ...
                    <div className="w-1/2 flex-auto">
                        ...
                        <div className="TechnologiesStyles__ListContainer-sc-1ehw0pq-3 dPpGTk">
                            ...
                            <ul className="flex gap-3">
                                <li>
                                    <i className="colored devicon-php-plain text-5xl"></i>
                                </li>
                                <li>
                                    <i className="devicon-csharp-plain colored text-5xl"></i>
                                </li>
                                <li>
                                    <i className="devicon-nodejs-plain colored text-5xl"></i>
                                </li>
                                <li>
                                    <i className="devicon-laravel-plain colored text-5xl"></i>
                                </li>
                                <li>
                                    <i className="devicon-dot-net-plain colored text-5xl"></i>
                                </li>
                                <li>
