    ...
    return (
        <section id='skill' className="py-20 bg-gradient-to-b from-vscode-blue via-blue-900 to-deep-space-black">
            <div className='container mx-auto'>
                <h1 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-100 to-gunmetal-gray my-4">Tecnologías</h1>
                ...
                <div className="flex flex-wrap">
                    <div className="w-1/2 flex-auto">
                        ...
                        <div className="TechnologiesStyles__ListContainer-sc-1ehw0pq-3 dPpGTk">
                            ...
                            <p className="text-xl text-slate-300 mb-2">
                                Experiencia en el desarrollo de interfaces web intuitivas y eficientes.
                            </p>
                            <p className="font-bold text-2xl mb-2">Stacks Principales</p>
                    ...
                    <div className="w-1/2 flex-auto">
                        ...
                        <div className="TechnologiesStyles__ListContainer-sc-1ehw0pq-3 dPpGTk">
                            ...
                            <p className="text-xl text-slate-300 mb-2">
                                Experiencia en el diseño, desarrollo y mantenimiento de aplicaciones web escalables y robustas.
                            </p>
                            <p className="font-bold text-2xl mb-2">Stacks Principales</p>
                            <ul className="flex gap-3">
                                <li>
